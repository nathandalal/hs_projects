 ...
 * its validity.
 *
 * A flag for keeping the lexeme the same as the token type is maintained
 * to meet the basic requirements of the Compilers and Interpreters course.
 *
 * @author Nathan Dalal
 *
 * Usage:
...
public class Token
{
    ...
    public static final String[] VALID_KEYWORD_LEXEMES = {"PROGRAM",
                                                          "VAR",
                                                          "PROCEDURE",
                                                          "BEGIN",
                                                          "RETURN",
